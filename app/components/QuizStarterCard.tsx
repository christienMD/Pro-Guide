      ...
      <CardBody placeholder="">
        <div className="flex flex-col md:flex-row justify-between mb-4 items-center">
          ...
          <div className="flex">
            ...
            <div
              data-dialog-backdrop="animate-dialog"
              data-dialog-backdrop-close="true"
              className="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300"
            >
              <div
                data-dialog="animate-dialog"
              ...
              >
                ...
                <div className="flex px-3">
                  <button
                    className="flex items-center gap-3 px-7 py-1 bg-[#f8f8f8] rounded-md cursor-default whitespace-nowrap"
                    type="button"
                  >
                    <svg
                      width="18"
                ...
                <div className="relative p-4 font-sans text-base antialiased font-light leading-relaxed text-black">
